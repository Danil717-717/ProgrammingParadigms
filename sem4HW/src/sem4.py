...
new_tuple = immutable_tuple + (10,) 
# Создание нового кортежа на основе старого

#В первом примере у нас есть изменяемый список #mutable_list, и мы изменяем его элемент. Во втором #примере у нас есть неизменяемый кортеж #immutable_tuple, и мы создаем новый кортеж new_tuple, #добавляя элемент к существующему.
